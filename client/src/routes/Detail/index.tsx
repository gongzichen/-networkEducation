...
function Detail(props: Props) {
	...
	const addCartItem = (lesson: Lesson) => {
		...
		let cart: HTMLSpanElement = document.querySelector('.action.anticon-shopping-cart')
	...
	return (
		<>
			...
			<Card hoverable style={{ width: '100%' }} cover={<img id="lesson-video" src={lesson.poster} />}>
